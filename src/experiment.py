...
def experiment(experiment_name="test",lr=1e-3, model_name="newUNet", num_filters=64, num_depth=5, activation_fn="relu", loss_fn="bce", batch_size=16, num_workers=0, max_epochs=1,
